...
instance Block Bool where
  ...
  sizeOf430 _    = 4
  isStruct _ = False
  read140  p (Diff o)   = liftIO $ toBool <$> peekByteOff p o
  write140 p (Diff o) b = liftIO $ pokeByteOff p o (fromBool b)
  read430 = read140
  write430 = write140
...
instance Block Float where
  ...
  sizeOf430 _    = 4
  isStruct _ = False
  read140 p (Diff o) = liftIO $ peekByteOff p o
  write140 p (Diff o) b = liftIO $ pokeByteOff p o b
  read430 = read140
  write430 = write140
...
instance Block BVec2 where
  ...
  sizeOf430 _    = 8
  isStruct _ = False
  read140  p (Diff o)   = liftIO $ fmap toBool <$> peekByteOff p o
  write140 p (Diff o) b = liftIO $ pokeByteOff p o (fmap fromBool b)
  read430 = read140
  write430 = write140
