...
import Data.Primitive.StateVar (StateVar(..))
...
hb_ft_face_create_referenced :: MonadIO m => FT.Face -> m (HB.Face RealWorld)
...
hb_ft_font_create_referenced :: MonadIO m => FT.Face -> m (HB.Font RealWorld)
