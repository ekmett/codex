...
import UI.Shaders
import Glow.Freetype.Atlas (Atlas)
import qualified Glow.Freetype.Atlas as Atlas
import Glow.Freetype.Font (Font)
import Glow.Freetype.Markup (Markup)
import qualified Glow.Freetype.Markup as Markup
import qualified Glow

{-
data FontUniforms = FontUniforms
  { pixel :: {-# unpack #-} !(V3 Float)
  , pvm ::   {-# unpack #-} !(M33 Float)
  }
